    ...
    try:
        ...
        with ExitStack() as stack:
            ...
            expected_status = (
                ...
                if args.solver == "approx"
                else pulp_status == "Optimal"
            )
            if objective is None or not solution or violations or not expected_status:
                raise RuntimeError(f"profile validation failed: {validation}")
